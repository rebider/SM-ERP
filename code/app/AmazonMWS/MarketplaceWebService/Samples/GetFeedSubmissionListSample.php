 ...
 *
 * 实例化MarketplaceWebService的实现
 *
 * AWS_ACCESS_KEY_ID和AWS_SECRET_ACCESS_KEY常量
 *在相同的.config.inc.php中定义
 *目录作为这个示例
 ***********************************************************************/
 ...
 * *取消注释，以尝试模拟MarketplaceWebService的模拟服务
 *响应时不调用MarketplaceWebService服务。
 *
 *响应从本地XML文件加载。您可以将XML文件调整为
 *在开发过程中尝试各种输出
 *
 * XML文件在MarketplaceWebService/Mock树下可用
 *
 ***********************************************************************/
