<?php
     ...
     * Author: zt7785
     */
    class RulesWarehouseCondition extends Model
    {
        protected $table = 'rules_warehouse_condition';
        ...
        public function RulesWarehouseCondition() {
            return $this->belongsTo(RulesWarehouseCondition::class, 'condition_id', 'id');
        }
        ...
        public static function troubleDatasLogics($datas,$conditionDatas,$userInfo) {
            ...
            $troubleField = ['trouble_rules_name','trouble_desc','trouble_type_id','opening_status','warehouse_ids'];
            //in 查询语句
