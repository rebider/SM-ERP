...
@section('content')
    <form class="layui-form" action="">
        ...
        <div style="text-align: center;margin-top: 50px;">
            <span>xlsx文件：</span>
            {{--<input type="file" class="" id="up_pci"--}}
                   {{--accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel"--}}
                   {{--placeholder="选择上传文件" name="up_pci">--}}
            <input type="file" name="up_pci" id="up_pci" placeholder="未选择任何文件" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" class="form-control">
        </div>
        <div style="text-align: center;margin-top: 50px;">
        ...
        layui.use(['layer', 'form', 'element', 'laydate', 'table', 'formSelects'], function () {
            ...
            form.on('submit(save)', function (data) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url:"{{ url('inventory/importAllocation') }}",
            ...
            window.downloadFile = function() {
                var url = ['/downloads/导入库存分配表.xlsx'];
