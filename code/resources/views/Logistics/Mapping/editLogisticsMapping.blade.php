...
@section('content')
        ...
        <form action="" method="post" class="layui-form myForm" id="myForm">
            ...
            <ul class="" style="margin: 0 6rem">
                    ...
                    <div class="layui-input-inline">
                        <select name="plat_id" id="plat_id" lay-verify="required">
                            ...
                            @foreach($platforms as $platform)
                                <option value="{{ $platform['id'] }}" @if($platform['id'] == $logisticsMapping['plat_id'])selected @endif>{{ $platform['name_EN'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </li>
                ...
                <li class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="plat_logistic_name" id="plat_logistic_name" type="text" value="{{$logisticsMapping ['plat_logistic_name']}}" lay-verify="required" style="
    width: 190px;">
                    </div>
                </li>
    ...
    width: 190px;" value="{{$logisticsMapping ['carrier_name']}}">
                    </div>
                </li>
                    ...
                    <div class="layui-input-inline">
                        <select name="logistic_id" id="logistic_id" lay-verify="required">
                            ...
                            @foreach($logistics as $logistic)
                                <option value="{{ $logistic['id'] }}" @if($logistic['id'] == $logisticsMapping['logistic_id'])selected @endif>{{ $logistic['logistic_name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </li>
