...
@section('content')
    ...
    <div id="rulecont05" class="outWindow hide">
        <div class="pop_textArea">
            <textarea class="numTxtarea" placeholder="支持格式：10000、10000~10008" name="post_code" id=""
                      value=""></textarea>
        </div>
    </div>
    <!--指定字段空-->
                ...
                <li>
                    ...
                    <div class="inpblock">
                        ...
                        <input class="kbinp layui-disabled" disabled type="number" min="0"
                               onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_length" value=""/> CM
                    </div>
                </li>
                <li>
                    ...
                    <div class="inpblock">
                        <select lay-filter="type" class="layui-disabled" disabled name="goods_width_unit" id="">
                            ...
                            <option value="<="> 小于等于(<=)</option>
                                         ...
                                         onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_width" value=""/> CM
                    </div>
                </li>
                <li>
                    ...
                    <div class="inpblock">
                        <select lay-filter="type" class="layui-disabled" disabled name="goods_height_unit" id="">
                            ...
                            <option value="<="> 小于等于(<=)</option>
                                         ...
                                         onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_height" value=""/> CM
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="proWeight layui-form">
            <ul class="flexlayer flexhelf ">
                ...
                <li class="alone">
                    ...
                    <div class="inpblock">
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="goods_weight_sc" title="按区间：" value="1"/></span>
                            <span class="tp"><input class="wval mx wmin" placeholder="最小值" type="number"
                                                    min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)"
                        ...
                        <div class="scope">
                            ...
                            <span class="tp"><input class="wval wet edgit" type="number" name="goods_weight_value" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" min="0"/></span>
                        </div>
                    </div>
                </li>
            </ul>
                ...
                <li class="alone">
                    ...
                    <div class="inpblock">
                        <div class="scope">
                            ...
                            <span class="tp">
                                <input class="wval mx" placeholder="最小值" type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="orders_price_min"/> ~
                                <input placeholder="最大值" class="wval mx" type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="orders_price_max"/>
                            </span>
                        </div>
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="orders_price_sc" title="按边界：" value="2"/></span>
                            <span class="tp">
                                <select name="orders_price_unit_type" id="">
                                    <option value=">=">大于等于(>=)</option>
                                    <option value="<=">小于等于(<=)</option>
                                </select>
                            </span>
                            <span class="tp"><input class="wval wet layui-disabled" type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)"
                                                    name="orders_price" readonly="readonly"/></span>
                        </div>
                    </div>
                </li>
            </ul>
                    ...
                    <div class="inpblock">
                        ...
                        <div class="scope">
                            ...
                            <span class="tp"><input class="wval wet layui-disabled" type="number" min="0"
                                                    ...
                                                    name="goods_count" readonly="readonly"/></span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <script>
        ...
        layui.use(['layer', 'form', 'element', 'laydate', 'table'], function () {
            ...
            function goodsWeightReload() {
                ...
                if ("{{isset($checkedDatas['goods_weight_info']['operator'])}}" == '~') {
                    radio_value = 1;
                } else {
                    radio_value = 2;
                }
                ...
                if (radio_value == 1) {
                    $('#rulecont09').find('.inpblock input[name="goods_weight_value_min"]').val('{{$checkedDatas['goods_weight_info']['value'][0] or ''}}');
                    $('#rulecont09').find('.inpblock input[name="goods_weight_value_max"]').val('{{$checkedDatas['goods_weight_info']['value'][1] or ''}}');
                } else {
            ...
            function deliverWareReload() {
                ...
                @if(isset ($checkedDatas['warehouse_id']))
                 ...
                 var str = $('<span data-type="3" data-value="{{$v['id']}}" data-name="warehouse_id[]" class="">' + "{{$v['warehouse_name']}}" + '</span>');
                settle.append(str);
                @endforeach
                @endif
            }
