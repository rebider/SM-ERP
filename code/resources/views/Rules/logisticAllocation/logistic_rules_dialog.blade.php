...
@section('content')
            ...
            <div class="ruleName">
                <ul class="flexlayer">
                    <li>
                        ...
                        <div class="inpblock">
                            <input lay-verify="required" maxlength="300" class="layui-input" type="text" placeholder="请输入规则名称" name="trouble_rules_name" value="">
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="writelist">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="opening_status" value="2" lay-skin="primary" checked title="否"/>
                    </div>
                </div>
            </div>
    ...
    <div id="rulecont04" class="outWindow hide">
        <div class="pop_textArea">
            <textarea class="numTxtarea" placeholder="支持格式：10000、10000~10008" name="exclude_post_code" id="" value=""></textarea>
        </div>
    </div>
    <!--指定邮编-->
    <div id="rulecont05" class="outWindow hide">
        <div class="pop_textArea">
            <textarea class="numTxtarea" placeholder="支持格式：10000、10000~10008" name="post_code"></textarea>
        </div>
    </div>
    <!--指定字段空-->
            ...
            <ul class="flexlayer">
                <li>
                    ...
                    <div class="inpblock">
                        ...
                        <input class="kbinp layui-disabled" disabled type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_length" value=""/> CM
                    </div>
                </li>
                <li>
                    ...
                    <div class="inpblock">
                        <select lay-filter="type" class="layui-disabled" disabled name="goods_width_unit" id="">
                            ...
                            <option value="=">等于(=)</option>
                            <option value="<="> 小于等于(<=)</option>
                        </select> <input class="kbinp layui-disabled" disabled type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_width" value=""/> CM
                    </div>
                </li>
                <li>
                    ...
                    <div class="inpblock">
                        <select lay-filter="type" class="layui-disabled" disabled name="goods_height_unit" id="">
                            ...
                            <option value="=">等于(=)</option>
                            <option value="<="> 小于等于(<=)</option>
                        </select> <input class="kbinp layui-disabled" disabled type="number" min="0" onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="goods_height" value=""/> CM
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="proWeight layui-form">
            <ul class="flexlayer flexhelf ">
                ...
                <li class="alone">
                    ...
                    <div class="inpblock">
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="goods_weight_sc" title="按区间：" value="1" checked/></span>
                            <span class="tp"><input class="wval mx wmin" placeholder="最小值" type="number" min="0"
                                                    onkeyup="clearNoNum(this)" onblur="clearNoNum(this)"
                                                    name="goods_weight_value_min"/> ~
                                <input onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" placeholder="最大值" class="wval mx wmax" type="number" min="0" name="goods_weight_value_max"/> </span>
                        </div>
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="goods_weight_sc" title="按边界：" value="2"/></span>
                            <span class="tp">
                        ...
                        <span class="tp"><input onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" class="wval wet edgit layui-disabled" type="number" min="0" name="goods_weight_value" readonly="readonly"/></span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <div id="rulecont10" class="outWindow hide">
        <div class="pop_textArea">
            <textarea class="numTxtarea" placeholder="支持格式：S1000，多个请用 回车 换行分隔" name="goods_sku" id=""></textarea>
        </div>
    </div>
    <!--商品金额-->
        ...
        <div class="proWeight layui-form">
            <ul class="flexlayer flexhelf orders_price_class">
                ...
                <li class="alone">
                    ...
                    <div class="inpblock">
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="orders_price_sc" title="按区间：" value="1" checked/></span>
                            <span class="tp"><input class="wval mx" placeholder="最小值" type="number" min="0"
                                                    onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name ="orders_price_min"/> ~ <input
                                        placeholder="最大值" class="wval mx" type="number" min="0"
                                        onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name ="orders_price_max"/></span>
                        </div>
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="orders_price_sc" title="按边界：" value="2"/></span>
                            <span class="tp"><select name="orders_price_unit_type" id="">
                                    <option value=">=">大于等于(>=)</option>
                                    <option value="<=">小于等于(<=)</option>

                                </select></span>
                            <span class="tp"><input class="wval wet layui-disabled" type="number" min="0"
                                                    onkeyup="clearNoNum(this)" onblur="clearNoNum(this)" name="orders_price" readonly ="readonly"/></span>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div class="proWeight layui-form">
            <ul class="flexlayer goods_count_class">
                <li>
                    <div class="inpblock">
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="goods_count_sc" title="按区间：" value="1" checked/></span>
                            <span class="tp"><input class="wval mx" placeholder="最小值" type="number" min="0"
                        ...
                        <div class="scope">
                            <span class="tp"><input type="radio" lay-filter="radio" name="goods_count_sc" title="按边界：" value="2"/></span>
                            <span class="tp"><select name="goods_count_unit_type" id=""><option value=">=">大于等于(>=)</option><option value="<=">小于等于(<=)</option></select></span>
                            <span class="tp"><input class="wval wet layui-disabled" type="number" min="0"
                                                    onkeyup="value=value.replace(/[^\d]/g,'')"
                                                    onblur="value=value.replace(/[^\d]/g,'')" name="goods_count" readonly="readonly"/></span>
                        </div>
                    </div>
                </li>
            </ul>
...
@section('javascripts')
    <script type="text/javascript" src="{{ asset('js/logistic_condition.js?'.time()) }}"></script>
    <script>
