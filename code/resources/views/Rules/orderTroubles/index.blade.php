        ...
        <form class="multiSearch layui-form">
            <div class="flexSearch flexquar fclear">
                ...
                <div>
                    ...
                    <div class="inputBlock">
                        <input type="text" name="trouble_rules_name"  placeholder="请输入规则名" autocomplete="off" class="voin">
                    </div>
                </div>
                ...
                <div class="search">
                        <div class="usebtn fl">
                            <button class="layui-btn layui-btn-danger" lay-submit="" lay-filter="searBtn" type="submit">搜索</button>
...
@section('javascripts')
    <script type="text/javascript" src="{{ asset('js/trouble_index.js?'.time()) }}"></script>
@endsection