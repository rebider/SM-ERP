            ...
            <ul class="flexlayer">
                <li>
                    ...
                    <div class="inpblock">
                        ...
                        <input class="kbinp layui-disabled" disabled type="number" min="0" onkeyup="value=value.replace(/[^\d]/g,'')"
                ...
                <li>
                    ...
                    <div class="inpblock">
                        <select lay-filter="type" class="layui-disabled" disabled name="goods_width_unit" id="">
                            ...
                            <option value="=">等于(=)</option>
                            <option value="<="> 小于等于(<=)</option>
                        </select> <input class="kbinp layui-disabled" disabled type="number" min="0" onkeyup="value=value.replace(/[^\d]/g,'')"
                    ...
                    <div class="inpblock">
                        <div class="scope">
                            ...
                            <span class="tp"><input class="wval mx wmin" placeholder="最小值" type="number" min="0"
                                        ...
                                        placeholder="最大值" class="wval mx wmax" type="number" min="0"                                                                                              onkeyup="value=value.replace(/[^\d]/g,'')"
                                        onblur="value=value.replace(/[^\d]/g,'')"
                        ...
                        <span class="tp"><input class="wval wet edgit" type="number" min="0" name="goods_weight_value"                                                                                        onkeyup="value=value.replace(/[^\d]/g,'')"
                    ...
                    <div class="inpblock">
                        ...
                        <div class="scope">
                            ...
                            <span class="tp"><input class="wval wet" type="number" min="0"
                                                    onkeyup="value=value.replace(/[^\d]/g,'')"
                                                    onblur="value=value.replace(/[^\d]/g,'')" name="orders_price"/></span>
                        </div>
                    </div>
                </li>
            </ul>
                ...
                <li>
                    <div class="inpblock">
                        ...
                        <div class="scope">
                            ...
                            <span class="tp"><input class="wval wet" type="number" min="0"
                                                    onkeyup="value=value.replace(/[^\d]/g,'')"
                                                    onblur="value=value.replace(/[^\d]/g,'')" name="goods_count"/></span>
                        </div>
                    </div>
                </li>
            </ul>
