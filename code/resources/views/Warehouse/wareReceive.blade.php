                ...
                <ul class="condSearch">
                    <li class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" name="number" placeholder="客诉单号/订单号/运单号"{{--lay-verify="required|number"--}} autocomplete="off" class="layui-input writeinput">
                        </div>
                    </li>
                    <li class="layui-inline">
                        ...
                        {{--<a href="madnewb1.html" class="layui-btn layui-btn-normal">批量接单</a>--}}
                    </li>
                </ul>
            </form>
        </div>
